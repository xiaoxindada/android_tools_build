...
#line 1397 "dtc-parser.c"
    break;

  case 3: /* header: DT_V1 ';'  */
#line 116 "dtc-parser.y"
                {
			(yyval.flags) = DTSF_V1;
		}
#line 1405 "dtc-parser.c"
    break;
...
#line 1722 "dtc-parser.c"
    break;

  case 35: /* propdataprefix: %empty  */
#line 355 "dtc-parser.y"
                {
			(yyval.data) = empty_data;
		}
#line 1730 "dtc-parser.c"
    break;

  case 36: /* propdataprefix: propdata ','  */
#line 359 "dtc-parser.y"
                {
			(yyval.data) = (yyvsp[-1].data);
		}
#line 1738 "dtc-parser.c"
    break;
...
#line 1970 "dtc-parser.c"
    break;

  case 78: /* integer_unary: '-' integer_unary  */
#line 533 "dtc-parser.y"
                            { (yyval.integer) = -(yyvsp[0].integer); }
#line 1976 "dtc-parser.c"
    break;

  case 79: /* integer_unary: '~' integer_unary  */
#line 534 "dtc-parser.y"
                            { (yyval.integer) = ~(yyvsp[0].integer); }
#line 1982 "dtc-parser.c"
    break;

  case 80: /* integer_unary: '!' integer_unary  */
#line 535 "dtc-parser.y"
                            { (yyval.integer) = !(yyvsp[0].integer); }
#line 1988 "dtc-parser.c"
    break;

  case 81: /* bytestring: %empty  */
#line 540 "dtc-parser.y"
                {
			(yyval.data) = data_add_marker(empty_data, TYPE_UINT8, NULL);
		}
#line 1996 "dtc-parser.c"
    break;

  case 82: /* bytestring: bytestring DT_BYTE  */
#line 544 "dtc-parser.y"
                {
			(yyval.data) = data_append_byte((yyvsp[-1].data), (yyvsp[0].byte));
		}
#line 2004 "dtc-parser.c"
    break;

  case 83: /* bytestring: bytestring DT_LABEL  */
#line 548 "dtc-parser.y"
                {
			(yyval.data) = data_add_marker((yyvsp[-1].data), LABEL, (yyvsp[0].labelref));
		}
#line 2012 "dtc-parser.c"
    break;

  case 84: /* subnodes: %empty  */
#line 555 "dtc-parser.y"
                {
			(yyval.nodelist) = NULL;
		}
#line 2020 "dtc-parser.c"
    break;

  case 85: /* subnodes: subnode subnodes  */
#line 559 "dtc-parser.y"
                {
			(yyval.nodelist) = chain_node((yyvsp[-1].node), (yyvsp[0].nodelist));
		}
#line 2028 "dtc-parser.c"
    break;

  case 86: /* subnodes: subnode propdef  */
#line 563 "dtc-parser.y"
                {
			ERROR(&(yylsp[0]), "Properties must precede subnodes");
			YYERROR;
		}
#line 2037 "dtc-parser.c"
    break;
